      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow p-6">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-indigo-600 text-white font-semibold py-2 rounded">Registrieren</button>
          </form>
          <p className="text-sm text-gray-600 mt-4">Schon ein Konto? <Link href="/account/login" className="text-indigo-600 underline">Login</Link></p>
        </div>
      </div>
    </Layout>
  )
